package com.acpitzone.chartanalysis.Utility;
...
public class Constants {
    ...
    public static final String redirectUrl="https://sdcsupermarket.com/ccavResponseHandler.php"; //this is test url you can modify with your on url, you can use php or jsp,
//    public static final String cancelUrl="http://122.182.6.216/merchant/ccavResponseHandler.jsp"; //this is test url you can modify with your on url
    public static final String cancelUrl="https://sdcsupermarket.com/ccavResponseHandler.php"; //this is test url you can modify with your on url
...
//    public static final String rsaKeyUrl="https://secure.ccavenue.com/transaction/jsp/GetRSA.jsp"; //this is test url you can modify with your on url
    public static final String rsaKeyUrl="https://sdcsupermarket.com/GetRSA.php";
}
