...
public class MainActivity extends AppCompatActivity {
    ...
    String url6 = "https://sdcsupermarket.com/fetch_video.php";
       ...
       // yt1.setOnClickListener((v) -> url.GotoYt(MainActivity.this, url3));
        ...
        yt1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                videoView1.setVideoURI(Uri.parse("android.resource://" + getPackageName() + "/" + R.raw.caintro));
                videoView1.start();
